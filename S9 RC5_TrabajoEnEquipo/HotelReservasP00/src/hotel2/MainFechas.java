...
/**
 * Menú de consola para la Solución 2 (Verificación de fechas superpuestas).
 */
public class MainFechas {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        Hotel miHotel = new Hotel("Hotel Guayaquil (Fechas)");
        ...
        while (true) {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    System.out.print("Fecha de entrada (yyyy-MM-dd): ");
                    LocalDate fe2 = LocalDate.parse(sc.nextLine(), formato);
                    System.out.print("Fecha de salida (yyyy-MM-dd): ");
                    LocalDate fs2 = LocalDate.parse(sc.nextLine(), formato);

                    boolean disp = miHotel.consultarDisponibilidad(numC, fe2, fs2);
                ...
                case 6:
                    System.out.println("Saliendo de Solución 2...");
                    sc.close();
                    return;
